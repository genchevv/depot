class LineItemsController < ApplicationController
  ...
  def destroy
    @line_item.destroy
    respond_to do |format|
      format.html { redirect_to store_index_url, notice: "The product was removed from the cart" }
  ...
  def decrement
    ...
    respond_to do |format|
      if @line_item.save
        ...
        format.html { redirect_to store_index_url, notice: 'Line item was successfully removed from the cart.' }
        format.js { @current_item = @line_item }
        format.json { render json: @line_item.errors, status: :unprocessable_entity }
      end
    end
